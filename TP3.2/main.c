...
#include "exercise_22.h"
#include "exercise_23.h"
#include "exercise_24.h"
#include "exercise_25.h"
#include "exercise_26.h"
#include "exercise_27.h"
#include "exercise_28.h"
#include "exercise_29.h"
#include "exercise_30.h"
...
int main(int argc, char *argv[]) {
	...
	int option;
	printf("Ingrese el numero de ejercicio [1-30] (0 para salir): ");
	scanf("%d", &option);
